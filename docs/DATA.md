...
Schema version 2 adds `drivingGuide`; version 3 adds `tubePlan`; version 4 adds JSON-defined budget categories. Older working copies are migrated sequentially using reviewed defaults bundled with the application.
